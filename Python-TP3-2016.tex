...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Python-TP3-2016_files/Python-TP3-2016_7_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\(I_{O}(S)\) pour une plaque rectangulaire homogène en aluminium.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Python-TP3-2016_files/Python-TP3-2016_43_0.jpeg}
    \end{center}
    { \hspace*{\fill} \\}
