...
{\color{incolor}In [{\color{incolor}5}]:} \PY{o}{\PYZpc{}}\PY{k}{matplotlib} \PY{n}{inline} 
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Python-TP3-2015_files/Python-TP3-2015_5_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
%\texttt{\color{outcolor}Out[{\color{outcolor}12}]:}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Python-TP3-2015_files/Python-TP3-2015_41_0.jpeg}
    \end{center}
    { \hspace*{\fill} \\}
...
%    \begin{Verbatim}[commandchars=\\\{\}]
%{\color{incolor}In [{\color{incolor}}]:} \PY{k+kn}{from} \PY{n+nn}{IPython.core.display} \PY{k+kn}{import} \PY{n}{HTML}
