...
\makeatother
    ...
    \subparagraph{TP 2 -- Informatique CM3 -- Octobre 2014}
...
mêmes de la premeire séance :

Vous aurez à écrire plusieurs scripts (script1.py , script2.py
,\ldots{}). Les scripts doivent être accompagnés par un par un document
descriptif unique ( README.txt ). Dans ce fichier, vous devrez décrire
le mode de fonctionnement des scripts et, si besoin, mettre vos
commentaires. Merci d'y écrire aussi vos nomes et prenoms complets. Tous
les fichiers doivent etre mis dans un dossier appelé TP1-nom1-nom2 et
ensuite être compressés dans un fichier TP1-nom1-nom2.tgz . Enfin vous
allez envoyer ce fichier par email à l'enseignant : soit Enrico
(enrico.calzavarini@polytech-lille.fr) ou Stefano
...
pour la définir en Python :
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}1}]:} \PY{c}{\PYZsh{}definition d\PYZsq{}une fonction}
...
%\texttt{\color{outcolor}Out[{\color{outcolor}9}]:}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Python-TP2-2014_files/Python-TP2-2014_21_0.jpeg}
    \end{center}
    { \hspace*{\fill} \\}
...
%\texttt{\color{outcolor}Out[{\color{outcolor}10}]:}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Python-TP2-2014_files/Python-TP2-2014_30_0.jpeg}
    \end{center}
    { \hspace*{\fill} \\}
...
le coefficient \(Q\) (dit coefficient de qualité). Ici on négligera le
poids de la roue.
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Python-TP2-2014_files/Python-TP2-2014_46_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
contrôlées à travers un fichier des donnes d'entrée. Ce fichier contient
...
dixième de millimetre, et une surface de travail de
...
%    \begin{Verbatim}[commandchars=\\\{\}]
%{\color{incolor}In [{\color{incolor}74}]:} \PY{k+kn}{from} \PY{n+nn}{IPython.display} \PY{k+kn}{import} \PY{n}{Image}
...
%\texttt{\color{outcolor}Out[{\color{outcolor}74}]:}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Python-TP2-2014_files/Python-TP2-2014_56_0.jpeg}
    \end{center}
    { \hspace*{\fill} \\}
...
\item
  ...
  \(y_2 = 75.0 \ mm\).
\item
  la barre de liaison a longueur \(l=300\ mm\) , hauteur \(h = 100\ mm\)
  et centre géométrique en \(x_3 = 50.0 \ mm\), \(y_3 = 50.0 \ mm\).
\end{itemize}
...
completement fraisé dans ce cas) et \(1\) s'il doit être gardé comme il
est.
...
[[ 0  1  2]
 ...
 [44 55 56]]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}67}]:} \PY{n}{n}\PY{o}{=}\PY{n}{tableau}\PY{p}{[}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{]} \PY{c}{\PYZsh{} copier un element du tableau  ,  tableau[num. ligne][num. colonne]}
...
\(j\) ) identifie la coordonnée horizontale \(x\).
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}68}]:} \PY{n}{c}\PY{o}{=}\PY{n}{tableau}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{]} \PY{c}{\PYZsh{} copier une colonne du tableau}
...
[ 0  1  4 44]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}69}]:} \PY{n}{d}\PY{o}{=}\PY{n}{tableau}\PY{p}{[}\PY{p}{:}\PY{l+m+mi}{2}\PY{p}{,}\PY{p}{:}\PY{l+m+mi}{2}\PY{p}{]} \PY{c}{\PYZsh{} copier une colonne du tableau}
...
[[0 1]
 [1 2]]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}70}]:} \PY{n}{tableau} \PY{o}{=} \PY{n}{tableau} \PY{o}{+} \PY{l+m+mi}{2}  \PY{c}{\PYZsh{}ajouter 2 aux éléments du tableau}
         \PY{k}{print}\PY{p}{(}\PY{n}{tableau}\PY{p}{)}
\end{Verbatim}
...
[[ 2  3  4]
 ...
 [46 57 58]]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{n}{tableau2} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{4}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{)}\PY{p}{)}  \PY{c}{\PYZsh{}définition d\PYZsq{}une matrice composée de zéros}
...
[[ 0.  0.  0.]
 ...
 [ 0.  0.  0.]]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}72}]:} \PY{k+kn}{import} \PY{n+nn}{numpy} \PY{k+kn}{as} \PY{n+nn}{np}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Python-TP2-2014_files/Python-TP2-2014_69_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
%
%            \begin{Verbatim}[commandchars=\\\{\}]
%{\color{outcolor}Out[{\color{outcolor}1}]:} <IPython.core.display.HTML at 0x104bafad0>
%\end{Verbatim}
