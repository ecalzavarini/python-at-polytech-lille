...
\makeatother
    ...
    \subparagraph{TP 2 -- Informatique CM3 -- Septembre 2015}
...
{\color{incolor}In [{\color{incolor}11}]:} \PY{c}{\PYZsh{} \PYZhy{}*\PYZhy{} coding: utf\PYZhy{}8 \PYZhy{}*\PYZhy{}}
\end{Verbatim}

    ou bien

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{c}{\PYZsh{} \PYZhy{}*\PYZhy{} coding: latin\PYZhy{}1 \PYZhy{}*\PYZhy{}}
\end{Verbatim}
...
pour la définir en Python :
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:} \PY{c}{\PYZsh{}definition d\PYZsq{}une fonction}
...
Par exemple :
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{k}{print}\PY{p}{(} \PY{n}{f}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{)} \PY{p}{,} \PY{n}{f}\PY{p}{(}\PY{l+m+mi}{2}\PY{p}{)} \PY{p}{,} \PY{n}{f}\PY{p}{(}\PY{l+m+mi}{3}\PY{p}{)} \PY{p}{,} \PY{n}{f}\PY{p}{(}\PY{l+m+mi}{4}\PY{p}{)} \PY{p}{,} \PY{n}{f}\PY{p}{(}\PY{l+m+mi}{5}\PY{p}{)} \PY{p}{,} \PY{n}{f}\PY{p}{(}\PY{l+m+mi}{6}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
(3, 5, 7, 9, 11, 13)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{k}{print}\PY{p}{(} \PY{n+nb}{type}\PY{p}{(}\PY{n}{f}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
<type 'function'>
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}16}]:} \PY{c}{\PYZsh{} definition d\PYZsq{}une seconde fonction}
...
hello Mark from Python!!!
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}17}]:} \PY{c}{\PYZsh{}definition  d\PYZsq{}une trosieme fonction}
...
\end{Verbatim}
            ...
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}17}]:} 'j'
\end{Verbatim}
        
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}18}]:} \PY{c}{\PYZsh{}definition d\PYZsq{}une liste de fonctions}
...
hello Dominique from Python!!!
    \end{Verbatim}
            ...
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}18}]:} 'e'
\end{Verbatim}
...
%    \begin{Verbatim}[commandchars=\\\{\}]
%{\color{incolor}In [{\color{incolor}19}]:} \PY{k+kn}{from} \PY{n+nn}{IPython.display} \PY{k+kn}{import} \PY{n}{Image}
...
%\texttt{\color{outcolor}Out[{\color{outcolor}19}]:}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Python-TP2-2015_files/Python-TP2-2015_23_0.jpeg}
    \end{center}
    { \hspace*{\fill} \\}
...
%\texttt{\color{outcolor}Out[{\color{outcolor}20}]:}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Python-TP2-2015_files/Python-TP2-2015_32_0.jpeg}
    \end{center}
    { \hspace*{\fill} \\}
...
départ le nombre de répétitions à faire.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}21}]:} \PY{n}{nb\PYZus{}repetitions} \PY{o}{=} \PY{l+m+mi}{3}
...
sortir de la boucle.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}22}]:} \PY{n}{nb\PYZus{}repetitions} \PY{o}{=} \PY{l+m+mi}{3}
         \PY{n}{i} \PY{o}{=} \PY{l+m+mi}{1}
...
Zéro!
    ...
    \paragraph{Création d'une légende sur un graphique}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}23}]:} \PY{o}{\PYZpc{}} \PY{n}{matplotlib} \PY{n}{inline}  
         
         \PY{k+kn}{from} \PY{n+nn}{math} \PY{k+kn}{import} \PY{o}{*}
         \PY{k+kn}{import} \PY{n+nn}{numpy} \PY{k+kn}{as} \PY{n+nn}{np}
         \PY{k+kn}{import} \PY{n+nn}{matplotlib.pyplot} \PY{k+kn}{as} \PY{n+nn}{plt}
         
         \PY{n}{t} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{linspace}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{10}\PY{p}{,}\PY{l+m+mi}{400}\PY{p}{)}   \PY{c}{\PYZsh{} Création d\PYZsq{}une array numpy : Temps = Abscisses }
         
         \PY{k}{def} \PY{n+nf}{U}\PY{p}{(}\PY{n}{t}\PY{p}{,}\PY{n}{Q}\PY{p}{)}\PY{p}{:}
             \PY{k}{return} \PY{n}{np}\PY{o}{.}\PY{n}{exp}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{l+m+mi}{2}\PY{o}{/}\PY{n}{Q}\PY{o}{*}\PY{n}{t}\PY{p}{)}\PY{o}{*}\PY{n}{np}\PY{o}{.}\PY{n}{cos}\PY{p}{(}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{pi}\PY{o}{*}\PY{n}{t}\PY{p}{)}  \PY{c}{\PYZsh{} Fonction U dépendant d\PYZsq{}un paramètre Q}
         ...
         \PY{n}{plt}\PY{o}{.}\PY{n}{legend}\PY{p}{(}\PY{n}{loc}\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{upper right}\PY{l+s}{\PYZsq{}}\PY{p}{)}        \PY{c}{\PYZsh{} Appel de la légende}
         
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}

    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Python-TP2-2015_files/Python-TP2-2015_48_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    

    \subsubsection{Script 3 : Calcul de la valeur critique du coefficient de qualité d'une
suspension}
...
7.0
    ...
    \subsubsection{Script 4 : Préparation des données d'entrée pour une machine-outil à
contrôle numérique}
...
%    \begin{Verbatim}[commandchars=\\\{\}]
%{\color{incolor}In [{\color{incolor}25}]:} \PY{k+kn}{from} \PY{n+nn}{IPython.display} \PY{k+kn}{import} \PY{n}{Image}
...
%\texttt{\color{outcolor}Out[{\color{outcolor}25}]:}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Python-TP2-2015_files/Python-TP2-2015_58_0.jpeg}
    \end{center}
    { \hspace*{\fill} \\}
...
complètement fraisé dans ce cas) et \(1\) s'il doit être gardé comme il
est.
...
\end{enumerate}
    ...
    \paragraph{Créer et manipuler un tableau multidimensionnel avec numpy}
...
[[ 0  1  2]
 ...
 [44 55 56]]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}27}]:} \PY{n}{n}\PY{o}{=}\PY{n}{tableau}\PY{p}{[}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{]} \PY{c}{\PYZsh{} copier un element du tableau  ,  tableau[num. ligne][num. colonne]}
...
\(j\) ) identifie la coordonnée horizontale \(x\).
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}28}]:} \PY{n}{c}\PY{o}{=}\PY{n}{tableau}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{]} \PY{c}{\PYZsh{} copier une colonne du tableau}
...
[ 0  1  4 44]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}29}]:} \PY{n}{d}\PY{o}{=}\PY{n}{tableau}\PY{p}{[}\PY{p}{:}\PY{l+m+mi}{2}\PY{p}{,}\PY{p}{:}\PY{l+m+mi}{2}\PY{p}{]} \PY{c}{\PYZsh{} copier une colonne du tableau}
...
[[0 1]
 [1 2]]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}30}]:} \PY{n}{tableau} \PY{o}{=} \PY{n}{tableau} \PY{o}{+} \PY{l+m+mi}{2}  \PY{c}{\PYZsh{}ajouter 2 aux éléments du tableau}
         \PY{k}{print}\PY{p}{(}\PY{n}{tableau}\PY{p}{)}
\end{Verbatim}
...
[[ 2  3  4]
 ...
 [46 57 58]]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}31}]:} \PY{n}{tableau2} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{4}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{)}\PY{p}{)}  \PY{c}{\PYZsh{}définition d\PYZsq{}une matrice composée de zéros}
...
[[ 0.  0.  0.]
 ...
 [ 0.  0.  0.]]
    ...
    \paragraph{Représenter graphiquement une matrice}
...
{\color{incolor}In [{\color{incolor}32}]:} \PY{k+kn}{import} \PY{n+nn}{numpy} \PY{k+kn}{as} \PY{n+nn}{np}
         ...
         \PY{n}{my\PYZus{}mat} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{random}\PY{o}{.}\PY{n}{random}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{50}\PY{p}{,} \PY{l+m+mi}{80}\PY{p}{)}\PY{p}{)} \PY{c}{\PYZsh{}création d\PYZsq{}une matrice aléatoire de 80x50 elements}
         
         \PY{n}{plt}\PY{o}{.}\PY{n}{matshow}\PY{p}{(}\PY{n}{my\PYZus{}mat}\PY{p}{)} \PY{c}{\PYZsh{} représentation graphique}
         
         \PY{n}{plt}\PY{o}{.}\PY{n}{xticks}\PY{p}{(}\PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{80}\PY{p}{,}\PY{l+m+mi}{10}\PY{p}{)}\PY{p}{)} \PY{c}{\PYZsh{} définition des marqueurs en x}
         \PY{n}{plt}\PY{o}{.}\PY{n}{yticks}\PY{p}{(}\PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{50}\PY{p}{,}\PY{l+m+mi}{10}\PY{p}{)}\PY{p}{)} \PY{c}{\PYZsh{} définition des marqueurs en y}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Python-TP2-2015_files/Python-TP2-2015_71_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}34}]:} \PY{n}{plt}\PY{o}{.}\PY{n}{matshow}\PY{p}{(}\PY{n}{my\PYZus{}mat}\PY{p}{,}\PY{n}{cmap}\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{Greys}\PY{l+s}{\PYZsq{}}\PY{p}{)} \PY{c}{\PYZsh{} représentation graphique en blanc et noir}
         \PY{n}{plt}\PY{o}{.}\PY{n}{colorbar}\PY{p}{(}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}        
\end{Verbatim}

    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Python-TP2-2015_files/Python-TP2-2015_72_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    
%    \begin{Verbatim}[commandchars=\\\{\}]
%{\color{incolor}In [{\color{incolor}36}]:} \PY{k+kn}{from} \PY{n+nn}{IPython.core.display} \PY{k+kn}{import} \PY{n}{HTML}
...
%
%        <ipython-input-36-6e0370214c4d> in <module>()
%          3     styles = open('custom.css', 'r').read()
%          4     return HTML(styles)
%    ----> 5 css\_styling()
%    
%
%        <ipython-input-36-6e0370214c4d> in css\_styling()
